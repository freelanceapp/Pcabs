                        ...
                        <form role="form"  method="post" action="<?php echo base_url('admin/outstation_add_package');?>">
                           <div class="box-body">
                              <div class="form-group">
                                 <label>Package</label>
                                 <select class="form-control regcom select2"  style="width: 100%;" name="package">
                                    <option value="">select</option>
                                    <?php 
                                    foreach ($fetch_car as $car) {
                                     ?> 
                                    <option value="<?php echo $car->id;?>"><?php echo $car->package_name;?></option>
                                    <?php }?>
                                 </select>
                              </div>
                              <div class="form-group">
                                 <label>Car Type</label>
                                 <select class="form-control regcom select2"  style="width: 100%;"name="cartype">
                                    <option value="">select</option>
                                    <?php 
                                    foreach ($fetch_car as $car) {
                                     ?> 
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control regcom" placeholder="Rate" name="standardrate">
                              </div>
                              <div class="form-group">
